...
# Now I take their dlog in order to plot their cummulative growth w.r.t the USD
...
I now have the estimates of volatility for each series (currency), and below I change the output to a usable Xts series for each column in gwt_xts. And I plot the Sigma (volatility) of each series. 
